...
object ItemRepository{
    ...
    suspend fun getItem(itemName: String, league: String = Config.getLeague(), language: String = Config.getLanguage()): ItemsModel  = MyApplication.getPoeNinjaLoading().loadItems(league, itemName, language)
